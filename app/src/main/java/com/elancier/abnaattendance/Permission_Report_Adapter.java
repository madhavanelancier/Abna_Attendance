...
public class Permission_Report_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Permission_Report_Adapter(Context context, List<People> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.permission_list_item, parent, false);
        vh = new ViewHolder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof ViewHolder) {
         ...
         /*   SimpleDateFormat date=new SimpleDateFormat("dd MMM yyyy");
            ...
            view.intime.setText(o.getimage()+" hr "+o.getip_address()+" min");
