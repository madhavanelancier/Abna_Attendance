...
public class All_Report_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public All_Report_Adapter(Context context, List<People> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
           ...
           // more = (ImageButton) v.findViewById(R.id.more);
            ...
            intime=(TextView) v.findViewById(R.id.textView9);
            outtime=(TextView) v.findViewById(R.id.textView10);
            status=(TextView) v.findViewById(R.id.textView6);
            layout=(CardView) v.findViewById(R.id.card);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof ViewHolder) {
            ...
            if(o.logout.equals("Present")) {
                view.status.setText("Present");
                view.status.setBackground(ctx.getResources().getDrawable(R.drawable.green_border));
            }
            else if(o.logout.equals("Absent")){
                view.status.setText("Absent");
                view.status.setBackground(ctx.getResources().getDrawable(R.drawable.red_border));
         ...
         /*   SimpleDateFormat date=new SimpleDateFormat("dd MMM yyyy");
            ...
            view.date.setText(dt+"\n"+mon);
            view.intime.setText(o.time);
            view.outtime.setText(o.print_user);
            view.layout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {

                    if(o.logout.equals("Present")) {
                        ctx.startActivity(new Intent(ctx, InOuts_Activity.class).putExtra("date", o.date));
                    }
                }
            });
