...
public class ImageParameters implements Parcelable {
    ...
    public com.elancier.abnaattendance.ImageParameters createCopy() {
        com.elancier.abnaattendance.ImageParameters imageParameters = new com.elancier.abnaattendance.ImageParameters();
    ...
    public static final Creator<ImageParameters> CREATOR = new Creator<ImageParameters>() {
        @Override
        public com.elancier.abnaattendance.ImageParameters createFromParcel(Parcel source) {
            return new com.elancier.abnaattendance.ImageParameters(source);
        }

        @Override
        public com.elancier.abnaattendance.ImageParameters[] newArray(int size) {
            return new com.elancier.abnaattendance.ImageParameters[size];
        }
    };
}
