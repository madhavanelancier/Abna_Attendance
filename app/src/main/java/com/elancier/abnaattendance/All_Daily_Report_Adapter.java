...
public class All_Daily_Report_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public All_Daily_Report_Adapter(Context context, List<People> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.all_daily_report_items, parent, false);
        vh = new ViewHolder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof ViewHolder) {
            ...
            if(position==0){
                view.date_header.setVisibility(View.VISIBLE);
                view.date_header.setText(o.date);
            }
//
            if(position>=1) {
                try {
                    if (!o.date.equals(p.date)) {
                        view.date_header.setVisibility(View.VISIBLE);
                        view.date_header.setText(o.date);
                    } else {
                        view.date_header.setVisibility(View.GONE);
                        view.date_header.setText(o.date);
                    }
                } catch (Exception e) {
           ...
           /*
            if(o.date.equals(p.date)){
                ...
                view.date_header.setVisibility(View.VISIBLE);
                view.date_header.setText(p.date);
